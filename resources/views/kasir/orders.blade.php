...
@section('title', 'All Orders - ' . config('app.name'))
@section('content')
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-xl font-bold text-gray-800">All Orders</h2>
            <p class="text-sm text-gray-500">View and manage all customer orders.</p>
        </div>
    ...
    @if ($orders->isEmpty())
        <div class="text-center py-16">
            ...
            <h3 class="text-base font-semibold text-gray-700 mt-2">No orders found</h3>
                    ...
                    @foreach ($orders as $order)
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-right">
                                <a href="{{ route('kasir.orders.show', $order->id) }}" class="inline-flex items-center gap-1 text-xs font-medium text-primary hover:text-primary/80">
